...
const AddEditTour = () => {
 ...
 {
  window.location.href = 'https://darkcodegaju.github.io/Easy-Image-Editor/';
 }
        ...
        <MDBCardBody>
          <MDBValidation onSubmit={handleSubmit} className="row g-3" noValidate>
            ...
            <button type="button"   className="btn btn-warning btn-rounded" onClick ={handlestar}><i className="fas fa-paint-brush"></i>   Draw Own Sketch</button>
               ...
               <div>or</div>
            <button type="button"   className="btn btn-info btn-rounded" onClick ={handlebeautify}><i className="fas fa-adjust"></i>   Beautify Your Sketch</button>
            <div>or</div>
